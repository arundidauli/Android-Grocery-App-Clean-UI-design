...
public class TopProductAdapter extends RecyclerView.Adapter<TopProductAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public TopProductAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
