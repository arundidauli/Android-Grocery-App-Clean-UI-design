...
public class BottomProductAdapter extends RecyclerView.Adapter<BottomProductAdapter.MyViewHolder> {
    private List<Product> productList;
    private Context context;
    private Integer count=1;

    public BottomProductAdapter(List<Product> productList, Context context) {
    ...
    @NonNull
    @Override
    public BottomProductAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
