...
import com.techastrum.myappcreater.Interface.StudentUpdateListener;
import com.techastrum.myappcreater.R;
import com.techastrum.myappcreater.activities.SearchActivity;
import com.techastrum.myappcreater.fragmentdialog.StudentUpdateDialogFragment;
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.editButtonImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                studentUpdateDialogFragment.show(((SearchActivity) context).getSupportFragmentManager(), Config.UPDATE_STUDENT);*/
            }
        });
    }
